...
dataset = pandas.read_excel("clean-xls-files/AMR-and-NSH-Buoy-Data1394-Clean-Data.xls")
...
########## Setting LassoCV and IterativeImputer
lasso = LassoCV()
iterimp = IterativeImputer(estimator=lasso, max_iter=5000, tol=1e-12, verbose=2)
...
########## Creating a csv file
micedataset.to_csv("multivariate-method-results/AMR-and-NSH-Buoy-Data1394-normalized-mice-lassocv.csv")